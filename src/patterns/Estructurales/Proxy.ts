...
class ProxySubject implements SubjectOne {
  ...
  private checkAccess(): boolean {
    console.log(
      "Proxy:Comprobando el acceso antes de enviar la petición al RealSubject"
    );
...
const realSubject: RealSubject = new RealSubject(); // Crea una nueva instancia del objeto RealSubject.
const proxy: ProxySubject = new ProxySubject(realSubject); // Crea una instancia del objeto ProxySubject y le pasa la instancia de RealSubject como argumento.
